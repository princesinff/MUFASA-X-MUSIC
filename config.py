...
OWNER_USERNAME = getenv("OWNER_USERNAME", "@anshh_hu")
BOT_USERNAME = getenv("BOT_USERNAME", "@midori_music_bot")
BOT_NAME = getenv("BOT_NAME", "•⏤‌𝄞⃝🍧 ‌⃪‌𝐌ɪᴅᴏʀɪ 𝐌ᴜsɪᴄ♥️꯭꯭꯭꯭ ꯭꯭᪳𝆺𝅥")
ASSUSERNAME = getenv("ASSUSERNAME", "•⏤‌𝄞⃝🍧 ‌⃪‌𝐌ɪᴅᴏʀɪ 𝐌ᴜsɪᴄ♥️꯭꯭꯭꯭ ꯭꯭᪳𝆺𝅥")
EVALOP = list(map(int, getenv("EVALOP", "6988735195").split()))
MONGO_DB_URI = getenv("MONGO_DB_URI", None)
LOGGER_ID = int(getenv("LOGGER_ID", -1002300353707))
DURATION_LIMIT_MIN = int(getenv("DURATION_LIMIT", 17000))
# External APIs - Get these from their respective providers
GPT_API = getenv("GPT_API")
DEEP_API = getenv("DEEP_API")
OWNER_ID = int(getenv("OWNER_ID", 6988735195))

# Heroku deployment settings - Refer to Heroku documentation on how to obtain these
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
HEROKU_API_KEY = getenv("HEROKU_API_KEY")
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/princesinff/MUFASA-X-MUSIC.git")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "Master")
GIT_TOKEN = getenv("GIT_TOKEN", None)

# Support and contact information - Provide your own support channels
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/PRINCE_BOT_UPDATE")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/+3HLIbNyjIOQ3OWRl")
...
if SUPPORT_CHANNEL:
    if not re.match("https://", SUPPORT_CHANNEL):
        raise SystemExit(
            "[ERROR] - Your SUPPORT_CHANNEL url is wrong. Please ensure that it starts with https://t.me/PRINCE_BOT_UPDATE"
        )

if SUPPORT_CHAT:
    if not re.match("(?:http|https)://", SUPPORT_CHAT):
        raise SystemExit(
            "[ERROR] - Your SUPPORT_CHAT url is wrong. Please ensure that it starts with https://t.me/+3HLIbNyjIOQ3OWRl"
)
